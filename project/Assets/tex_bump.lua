...
brick = gr.texture_map('Assets/textures/brick.png')
brick_bm = gr.bump_map('Assets/textures/brick.png')
-- sand_bm = gr.bump_map('Assets/textures/sand.png')
...
s2:set_bump_map(brick_bm)
s2:set_texture_map(brick)
s2:scale(3.0, 3.0, 3.0)
s2:translate(-4.0, 3.0, 8.0)

gr.render(scene,
	  'texture_and_bump2.png', 1024, 1024,
