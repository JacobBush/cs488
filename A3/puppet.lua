...
left_wrist_hand = gr.joint('left_wrist_hand', {-1.0,0,1.0}, {0,0,0})
...
leftHand:scale(0.2,0.15,0.1)
leftHand:translate(0.0,-0.075,0.0)
...
right_wrist_hand = gr.joint('right_wrist_hand', {-0.6,0,0.6}, {0,0,0})
